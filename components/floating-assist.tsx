...
function WhatsAppIcon({size = 27}: {size?: number}) {
  return (
  ...
  return (
    <>
      ...
      <a
        ...
        aria-label={label}
        title={label}
        className="sm-whatsapp-float"
      >
        <span className="sm-whatsapp-pulse" aria-hidden="true" />
        <WhatsAppIcon />
        <span className="sm-floating-tooltip">
